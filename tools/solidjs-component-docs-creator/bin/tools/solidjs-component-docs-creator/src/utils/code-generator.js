...
exports.generateCodeFiles = void 0;
...
var transformRoutes = function (_a) {
    ...
    var CONFIG = (0, index_1.getConfig)();
...
function generateCodeFiles() {
    resources.forEach(function (_a) {
        var filename = _a.filename, transform = _a.transform;
        var filePath = (0, path_1.join)(resourcesFolder, filename);
        var content = (0, fs_1.readFileSync)(filePath, { encoding: 'utf8' });
        transform({ filename: filename, content: content });
    });
}
